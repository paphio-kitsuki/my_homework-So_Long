...
{	
	...
	frame->list = ft_lstnew(create_object(160, 0, get_image(WALL)));
	frame->list = ft_lstnew(create_object(320, 320, get_image(COLLECTION)));
	frame->list = ft_lstnew(create_object(80, 640, get_image(GOAL)));
